    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between items-center">
        <div className="mb-4 md:mb-0 text-center md:text-left">
          <h2 className="text-2xl font-semibold text-gray-800">gift loves</h2>
        ...
        <div className="flex space-x-6 mt-4 md:mt-0 justify-center md:justify-end">
          <a href="https://facebook.com" className="text-gray-800 hover:text-blue-600 transition-colors duration-300" aria-label="Facebook">
          ...
          <a href="https://twitter.com" className="text-gray-800 hover:text-blue-400 transition-colors duration-300" aria-label="Twitter">
          ...
          <a href="https://linkedin.com" className="text-gray-800 hover:text-blue-700 transition-colors duration-300" aria-label="LinkedIn">
